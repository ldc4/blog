...
/* harmony import */ var _tags_less__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(195);
/* harmony import */ var _tags_less__WEBPACK_IMPORTED_MODULE_9___default = /*#__PURE__*/__webpack_require__.n(_tags_less__WEBPACK_IMPORTED_MODULE_9__);
...
function (_React$Component) {
  _babel_runtime_helpers_inheritsLoose__WEBPACK_IMPORTED_MODULE_3___default()(TagsPage, _React$Component);
  ...
  _proto.getTagsHTML = function getTagsHTML(tags) {
    var tagsHTML = [];
    tags.forEach(function (tag, index) {
      tagsHTML.push(react__WEBPACK_IMPORTED_MODULE_4___default.a.createElement("div", {
        className: "tag",
        key: "col-" + index
        ...
        className: "tag-value"
      }, tag.tagValue), react__WEBPACK_IMPORTED_MODULE_4___default.a.createElement("div", {
        className: "tag-count"
      }, tag.tagCount))));
    });
    return react__WEBPACK_IMPORTED_MODULE_4___default.a.createElement("div", {
      className: "tags-wrap page-content"
    }, tagsHTML);
  };
  ...
  _proto.render = function render() {
    ...
    var tags = allMarkdownRemark.edges;
...
function dealWithTags(arr) {
  // 将多个tag先拆分出来
  var result = [];
  var noTagCount = 0; // 统计没有tag的个数

  arr.forEach(function (item) {
    var _item$node$frontmatte = item.node.frontmatter,
        tags = _item$node$frontmatte.tags,
    ...
    if (tags && tags.length > 0) {
      tags.forEach(function (tag) {
        ...
        if (index >= 0) {
          ...
          result.push({
            tagValue: tag,
            tagLink: Object(lodash__WEBPACK_IMPORTED_MODULE_6__["kebabCase"])(tag),
            tagCount: 1
          });
        }
      });
...
//# sourceMappingURL=component---src-pages-tags-js-88aa2150be52c99d8923.js.map